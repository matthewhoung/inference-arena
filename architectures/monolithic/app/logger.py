...
for the monolithic inference service. Logs metadata only (no image payloads)
for efficient log analysis and performance monitoring.
...
class JSONFormatter(logging.Formatter):
    ...
    Example output:
        {"timestamp": "2025-12-17T10:30:45", "level": "INFO",
         "logger": "app.main", "message": "Predict complete",
         "request_id": "uuid-here", "endpoint": "/predict",
         "latency_ms": 123.45, "detections": 4, "status_code": 200}
    """
